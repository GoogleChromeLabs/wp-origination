...
* [open an issue](https://github.com/westonruter/wp-sourcery/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/westonruter/wp-sourcery/compare) to the `master` branch
